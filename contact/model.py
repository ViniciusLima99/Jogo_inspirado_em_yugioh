...
class Player(models.Model):
    ...
    feiticos = JSONField( blank=True, default=list)
    imagens_feiticos = JSONField( blank=True, default=list)

    limite = models.IntegerField(default=3)

    # Fase 3
    par_linha_coluna = JSONField(blank=True, default=list)
    ...
    monstros_fase3 = JSONField( blank=True, default=list)
    ...
    lista_boss = JSONField(blank=True, default=default_lista_boss)
    boss_escolhido = models.CharField(max_length=255, default='')
    boss_escolhido_atk = models.IntegerField(default=0)

    lista_imagem = JSONField( blank=True, default=default_lista_imagem)

    # batalha3lista = ArrayField(ArrayField(JSONField()), blank=True, default=default_batalha3lista)
    batalha3lista = JSONField(
        blank=True,
        default=default_batalha3lista
    )
    cardlist = JSONField(blank=True, default=default_cardlist)